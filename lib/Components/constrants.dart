...
const kPrimaryBlueColor = Color.fromARGB(255, 87, 90, 137);
const kPrimaryDarkColor = Color.fromARGB(255, 47, 46, 65);
const kPrimaryGreenColor = Color.fromARGB(240, 0, 222, 59);